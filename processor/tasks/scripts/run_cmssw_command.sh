...
echo "Before --nThreads change $CMSDRIVER_COMMAND"
...
echo "After --nThreads change $CMSDRIVER_COMMAND"
# if there is --python_filename=some_file.py replace it with --python_filename=nano_config.py
echo "Before --python_filename change $CMSDRIVER_COMMAND"
...
echo "After --python_filename change $CMSDRIVER_COMMAND"
# if there is --fileout file:somefilename.root replace it with --fileout file:nanoAOD.root
echo "Before --fileout change $CMSDRIVER_COMMAND"
...
echo "After --fileout change $CMSDRIVER_COMMAND"
